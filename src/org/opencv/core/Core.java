...
public class Core {
    ...
    public static final String VERSION = "2.4.5.0", NATIVE_LIBRARY_NAME = "opencv_java245";
    public static final int VERSION_EPOCH = 2, VERSION_MAJOR = 4, VERSION_MINOR = 5, VERSION_REVISION = 0;
